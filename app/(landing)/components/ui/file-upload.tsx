...
const FileUpload = ({onFileSelect}: TFileUploadProps) => {
    ...
    className="flex flex-col justify-center items-center w-full py-6 border border-dashed border-primary bg-primary-alternate cursor-pointer">
        <input 
        type="file" 
        className="hidden" 
        ref={fileInputRef} 
...

        {
            !file ? (
                ...
                <div className="text-center">
                    ...
                    <button 
                    onClick={removeFile} 
                    className="cursor-pointer flex gap-2 bg-primary/90 text-white mx-auto rounded mt-4 px-2">
